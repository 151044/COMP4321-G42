...
public class DocumentTest {
    ...
    void retrieveFromWebBody() throws IOException {
        ...
        expectedMap.put("thi", new WordInfo(5, 0, 0, 0, "s"));
        ...
        expectedMap.put("befor", new WordInfo(5, 1, 0, 0, "e"));
        expectedMap.put("gett", new WordInfo(5, 1, 0,1, "ing"));
        expectedMap.put("admission", new WordInfo(5, 1, 0, 3, ""));
        expectedMap.put("cse", new WordInfo(5, 1, 0,5, ""));
        expectedMap.put("depart", new WordInfo(5, 1, 0, 6, "ment"));
        expectedMap.put("hkust", new WordInfo(5, 1, 0,8, ""));
        expectedMap.put("read", new WordInfo(5, 1, 0, 11, ""));
        expectedMap.put("internat", new WordInfo(5, 1, 0,14, "ional"));
        expectedMap.put("news", new WordInfo(5, 1, 0,15, ""));
        expectedMap.put("book", new WordInfo(5, 1, 0,18, "s"));
        expectedMap.put("movi", new WordInfo(5, 2, 0,3, "e"));
